...
return '<html><head><link rel=\'stylesheet\'' +
    ...
    'This app is used to email the user\'s current selection of cells in ' + 
    'Google Sheets as a table. The values that the user sets for emails, CC ' + 
    'emails the subject line, and the text to prepend to the table persist ' +  
    'after the document is closed, allowing a user to frequently send out ' +  
    'emails with updated tables, minimizing time spent on the repetitive ' + 
    'task of repeatedly  entering emails, subject lines, etc. The text below ' + 
    'outlines each of this app\'s functions.<br><br>' +
    'Send Table: Send the selected cells as a chart. The email\'s properties ' + 
    'are dependant upon the user\'s input in "Edit Email Properties".<br><br>' +
    'Edit Email Properties:<br>' +
    '&nbsp;&nbsp;>&nbsp;&nbsp;Set Emails: Enter a list of comma-separated ' +
    'emails that will receive the email you send.<br>' +
    '&nbsp;&nbsp;>&nbsp;&nbsp;Set CC: Enter a list of comma-separated emails ' + 
    'that will be CC\'d with the email you send.<br>' +
    '&nbsp;&nbsp;>&nbsp;&nbsp;Set Subject: Enter the text that will be used ' +
    'as the subject line in the email you send.<br>' +
    '&nbsp;&nbsp;>&nbsp;&nbsp;Set Body Text: Enter the body text that will ' + 
    'prepend the table in the email you send.<br>' +
...
/**
 * Function to clear all properties stored in the document.
 */
